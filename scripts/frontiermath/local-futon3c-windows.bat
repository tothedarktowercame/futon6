...
echo [frontiermath-local] NOTE: proof-state-root remains a general cross-repo design issue; this wrapper does not invent a futon3c-local special case.
...
echo   - does not set FUTON3C_PROOF_STATE_ROOT; that abstraction is still open
exit /b 0
