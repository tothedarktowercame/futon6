...
echo "[all] llm: stage3_batch=$LLM_STAGE3_BATCH_SIZE chunks=$LLM_STAGE3_CHUNKS_PER_SHARD stage6_batch=$LLM_STAGE6_BATCH_SIZE stage6_chunks=$LLM_STAGE6_CHUNKS_PER_SHARD base_batch=$LLM_BATCH_SIZE replica_gpu_workers=$LLM_GPU_WORKERS loader_workers=${LLM_LOADER_WORKERS:-auto}"
