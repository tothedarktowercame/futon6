...
CODE_ROOT="${FUTON_CODE_ROOT:-$(dirname "$REPO_ROOT")}"
STORAGE_ROOT="${FUTON6_STORAGE_ROOT:-$CODE_ROOT/storage}"
SRC_DIR="${FUTON3C_ROOT:-$CODE_ROOT/futon3c}/data/apm-informal-proofs"
FROZEN="$STORAGE_ROOT/apm/mark4-frozen-candidates.txt"
OUT_DIR="$STORAGE_ROOT/apm/mark4-tex"
