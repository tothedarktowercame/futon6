...
STAGES = [
    ...
    {"id": "7c.rung3-3", "device": "cpu/GPU", "status": "built",
     "consumes": ["technique-gap-map"], "produces": "technique-questions",
     "path": "data/rung3-questions/loop-run-70b/{pid}.questions.json",
     "needs": ["questions"]},
    {"id": "8.cas_cert", "device": "cpu", "status": "in-flight",
     "consumes": ["semcheck-profile", "topology+sorry", "symbol-grounding", "technique-gap-map", "technique-questions"], "produces": "port-ledger",
