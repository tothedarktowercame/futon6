...
# Defaults assume an 8-GPU / many-CPU box, but every hardware value is an env
# knob. Rob can raise limits and point --concepts/--golden-dir at all-arXiv.
#
# Environment:
#   NUM_GPUS              GPU count hint (default: 8)
#   EMBED_BATCH           BGE encode/train batch size (default: 256)
#   NUM_CPU_WORKERS       dataloader workers (default: SLURM_CPUS_PER_TASK or 32)
...
export NUM_GPUS EMBED_BATCH NUM_CPU_WORKERS NUM_SHARDS BGE_MODEL
