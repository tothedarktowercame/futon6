...
|---|---:|---:|---:|---:|---|
| CAS-0 strict verified | 22 | 15 | 7 | 31.8% | Current committed selector's honest strict share; this is the measured LLM/verifier residue on worked proof moves. |
...
| combined candidate surface | 50 | 43 | 7 | 14.0% | Upper-bound deterministic menu reach if loop retrieval candidates are later verified. |

Strict CAS-0 residue is therefore **7/22 = 31.8%**. That number is the empirical LLM share for the current CAS-0 verified setting.
...
| `a93J05` | `s2` | `reduce-to-known-result` | `reduce-to-known-result` | `verifiable` | `grounded` | `reduce-to-known-result, check-the-extreme-cases, structural-obstruction-as-theorem, argue-by-contradiction` |
...
| `a93J05` | `s4` | `local-to-global` | `local-to-global` | `heuristic` | `thin` | `local-to-global, estimate-by-bounding, reduce-to-known-result, transport-across-isomorphism` |
| `a93J05` | `s5` | `reduce-to-known-result` | `reduce-to-known-result` | `verifiable` | `grounded` | `reduce-to-known-result, hybrid-certification, structural-obstruction-as-theorem, argue-by-contradiction` |
| `a96J01` | `s1` | `construct-an-explicit-witness` | `construct-an-explicit-witness` | `verifiable` | `grounded` | `use-probabilistic-method, construct-an-explicit-witness, argue-by-contradiction, monotone-approximation` |
| `a96J01` | `s2` | `construct-auxiliary-object` | `NONE` | `none` | `ungrounded` | `split-into-cases, separate-into-independent-pieces, the-diagonal-argument, unfold-the-definition` |
| `a96J01` | `s3` | `separate-into-independent-pieces` | `NONE` | `none` | `ungrounded` | `pass-to-a-subsequence, the-diagonal-argument, unfold-the-definition, use-probabilistic-method` |
| `a96J01` | `s4` | `reduce-to-known-result` | `NONE` | `none` | `ungrounded` | `argue-by-contradiction, quotient-by-irrelevance, the-diagonal-argument, unfold-the-definition` |
...
| `a96J04` | `s1` | `unfold-the-definition` | `unfold-the-definition` | `verifiable` | `grounded` | `unfold-the-definition, separate-into-independent-pieces, split-into-cases, the-diagonal-argument` |
| `a96J04` | `s2` | `unfold-the-definition` | `NONE` | `none` | `ungrounded` | `structural-inclusion, numerical-scout, pass-to-a-subsequence, split-into-cases` |
| `a96J04` | `s3` | `unfold-the-definition` | `unfold-the-definition` | `verifiable` | `grounded` | `unfold-the-definition, argue-by-contradiction, quotient-by-irrelevance, the-diagonal-argument` |
...
| `b97J01` | `s1` | `construct-an-explicit-witness` | `construct-an-explicit-witness` | `verifiable` | `grounded` | `construct-an-explicit-witness, the-diagonal-argument, use-probabilistic-method, structural-obstruction-as-theorem` |
...
| `b97J01` | `s3` | `reduce-to-known-result` | `reduce-to-known-result` | `verifiable` | `grounded` | `reduce-to-known-result, count-over-a-decomposition, exhaustion-as-theorem, structural-obstruction-as-theorem` |
...
| `b97J01` | `s6` | `construct-auxiliary-object` | `NONE` | `none` | `ungrounded` | `construct-an-explicit-witness, pass-to-a-subsequence, the-diagonal-argument, unfold-the-definition` |
...
|---|---|---:|---|---|---|---|
| `0705.0452` | `edge-1` | `1290-1293` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, pass-to-a-subsequence, unfold-the-definition, local-to-global` |
...
| `0705.0452` | `edge-3` | `1298-1302` | `pass-to-a-subsequence` | `heuristic` | `thin` | `pass-to-a-subsequence, reduce-to-known-result, structural-equivalence, structural-obstruction-as-theorem` |
...
| `0708.2067` | `edge-1` | `392-393` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, construct-an-explicit-witness, pass-to-a-subsequence, use-probabilistic-method` |
| `0708.2067` | `edge-2` | `395-397` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, pass-to-a-subsequence, local-to-global, epsilon-of-room` |
...
| `0709.0248` | `edge-2` | `1516-1517` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, structural-characterization, structural-inclusion, structural-obstruction-as-theorem` |
...
| `0712.0724` | `edge-2` | `894-895` | `pass-to-a-subsequence` | `heuristic` | `thin` | `pass-to-a-subsequence, reduce-to-known-result, count-over-a-decomposition, structural-equivalence` |
| `0712.0724` | `edge-3` | `903-907` | `pass-to-a-subsequence` | `heuristic` | `thin` | `pass-to-a-subsequence, reduce-to-known-result, structural-equivalence, induction-and-well-ordering` |
...
| `0801.0199` | `edge-2` | `390-390` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, pass-to-a-subsequence, quotient-by-irrelevance, induction-and-well-ordering` |
| `0801.0199` | `edge-3` | `390-390` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, pass-to-a-subsequence, unfold-the-definition, local-to-global` |
| `0801.0199` | `edge-4` | `390-390` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, pass-to-a-subsequence, local-to-global, epsilon-of-room` |
| `0801.0199` | `edge-5` | `392-392` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, pass-to-a-subsequence, local-to-global, epsilon-of-room` |
| `0801.3843` | `edge-1` | `652-656` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, pass-to-a-subsequence, local-to-global, epsilon-of-room` |
| `0801.3843` | `edge-2` | `658-658` | `structural-equivalence` | `heuristic` | `thin` | `structural-equivalence, encode-as-algebra, pass-to-a-subsequence, local-to-global` |
