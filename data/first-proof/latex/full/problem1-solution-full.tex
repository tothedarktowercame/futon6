...
\[dT_{h}^{\mDualStar} \mu_\mNumber{0} / dmu_\mNumber{0} (\phi) = \exp(l_{h}(\phi) - ||h||_H^\mNumber{2} / \mNumber{2})\]
...
\[dT_{\psi}^{\mDualStar} \mu / dmu_\mNumber{0} (\phi) = Z^{-\mNumber{1}} \exp(-V(\phi - \psi)) \ast \exp(l_{\psi}(\phi) - ||\psi||_H^\mNumber{2}/\mNumber{2})\]
...
The Radon-Nikodym derivative \(dT_{\psi}^{\mDualStar} \mu /\)dmu involves:
