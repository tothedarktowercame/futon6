...
\(E_{\mu_{\mNumber{0}}}[\\exp(-V)] <\) infinity and hence \(\mu << \mu_{\mNumber{0}}\) with strictly positive
...
\[dT_{h}^{\mDualStar} \mu_\mNumber{0} / d\mu_\mNumber{0} (\phi) = \exp(l_{h}(\phi) - ||h||_H^\mNumber{2} / \mNumber{2})\]
...
\[dT_{\psi}^{\mDualStar} \mu / d\mu_\mNumber{0} (\phi) = Z^{-\mNumber{1}} \exp(-V(\phi - \psi)) \ast \exp(l_{\psi}(\phi) - ||\psi||_H^\mNumber{2}/\mNumber{2})\]
...
The Radon-Nikodym derivative \(dT_{\psi}^{\mDualStar} \mu / d\mu\) involves:
...
where \(t_\mNumber{0} > \mNumber{0}\) depends on \textbar\textbar psi\textbar\textbar{}\emph{\{\(\mathbb{C}^{\mNumber{0}}\)\} and the coupling constant.
...
in the Radon-Nikodym derivative is bounded by 4 \textbar\textbar psi\textbar\textbar{}}\{\(\mathbb{C}^{\mNumber{0}}\)\} \textbar int \(:\phi^\mNumber{3}:\) dx\textbar,
