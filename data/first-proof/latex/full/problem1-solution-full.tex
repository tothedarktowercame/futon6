...
\[\begin{aligned}
V(\phi - \psi) = V(\phi) - \mNumber{4} \Integral \psi :\phi^\mNumber{3}:\,dx + \mNumber{6} \Integral \psi^\mNumber{2} :\phi^\mNumber{2}:\,dx \\
- \mNumber{4} \Integral \psi^\mNumber{3} :\phi:\,dx + \Integral \psi^\mNumber{4}\,dx \\
- C(\Integral :\phi^\mNumber{2}:\,dx - \mNumber{2} \Integral \psi :\phi:\,dx + \Integral \psi^\mNumber{2}\,dx) + (renorm. corrections)
\end{aligned}\]
...
\[E_{\mu}[\exp(t |\Integral \psi :\phi^\mNumber{3}:\,dx|)] < \infty \text{for} |t| < t_\mNumber{0}\]
...
in the Radon-Nikodym derivative is bounded by 4 \(\|\psi\|_{C^{\mNumber{0}}} |\Integral :\phi^{\mNumber{3}}:\,dx|,\)
