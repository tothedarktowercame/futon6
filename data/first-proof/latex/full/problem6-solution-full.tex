...
At \(t \le \epsilon \ast |I_{\mNumber{0}}'|/\mNumber{3}\) and \(r_{t} \ge |I_{\mNumber{0}}'|(\mNumber{1} - \epsilon/\mNumber{3}) \ge \mNumber{2}|I_{\mNumber{0}}'|/\mNumber{3}\):
...
\(P(|S| \ge \epsilon \ast n/\mNumber{6}) \ge \mNumber{1} - \exp(-\epsilon \ast n/\mNumber{18})\). Numerically:
...
The remaining gap is not "we don\textquotesingle t know enough math"; it is "we are
