...
\(K_{n}, C_{n},\) Barbell, DisjCliq, ER(n,p) for \(n \in [\mNumber{8},\mNumber{64}]\) and \(\epsilon \in {\mNumber{0}.\mNumber{12}\), 0.15, 0.2, 0.25, 0.3\}:
...
\item
  ...
  DisjCliq, ER(n,p) graphs, \(\epsilon \in {\mNumber{0}.\mNumber{12}\), 0.15, 0.2, 0.25, 0.3\}.
