...
\(\gamma_{\mNumber{1}}(t) =\) (t, 0) for \(t \ge \delta, \gamma_{\mNumber{1}}(t) = (\mNumber{0},\) -t) for t \(\le -\delta,\)
...
Define \(S_{\epsilon}(x) = \chi(x_{\mNumber{1}}/\epsilon) S_{\mNumber{1}}(x) + (\mNumber{1} - \chi(x_{\mNumber{1}}\)/eps)) \(S_\mNumber{2}(x)\) for a
...
\(S_{t}(x) = \chi(x_{\mNumber{1}}/t) S_{\mNumber{1}}(x) + (\mNumber{1} - \chi(x_{\mNumber{1}}\)/t)) \(S_\mNumber{2}(x)\) defines a smooth
