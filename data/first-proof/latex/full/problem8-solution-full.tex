...
Identify \(\mathbb{R}^{\mNumber{4}} = \mathbb{C}^{\mNumber{2}}\) with symplectic form \(\omega = dx_{\mNumber{1}} \wedge dy_{\mNumber{1}} \mBridgeOperator{+} dx_{\mNumber{2}} \wedge dy_{\mNumber{2}}\).
...
exact 1-form \(dS_{eps}\)). For any fixed \(eps > \mNumber{0}\), this gives a smooth Lagrangian
...
the 1-form \(i_{d/dt}(\omega)|\)\emph{\(\{K_{t}\}\) is exact (it equals d(\(S_{t}\)\textbar{}}\{\(K_{t}\)\})),
