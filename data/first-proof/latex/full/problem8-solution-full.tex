...
\[\begin{aligned}
C_\mNumber{1} = {(x, \mNumber{0}) : x \ge \mNumber{0}} ∪ {(\mNumber{0}, y) : y \ge \mNumber{0}} \subset V_\mNumber{1} (positive x \text{and} y axes) \\
C_\mNumber{2} = {(u, \mNumber{0}) : u \ge \mNumber{0}} ∪ {(\mNumber{0}, v) : v \ge \mNumber{0}} \subset V_\mNumber{2} (positive u \text{and} v axes)
\end{aligned}\]
...
\[\begin{aligned}
C_\mNumber{1}^{sm}: smooth curve \in V_\mNumber{1}, = {(x, \mNumber{0})} \text{for} x > \delta, = {(\mNumber{0}, y)} \text{for} y > \delta, \\
smooth \text{through} \text{the} origin (e.g., \text{the} curve (cos \theta, sin \theta) \\
reparameterized \text{to} match \text{the} axes \text{outside} \text{the} transition) \\
