...
\textbf{Yes for n \textless= 4.} The inequality
holds in all tested trials (n = 2-5) with no violations.
Proved analytically for n = 2 (equality) and n = 3 (strict inequality
via Cauchy-Schwarz), and proved for n = 4 by algebraic elimination plus
computational certification of the remaining generic branch.
Open for n \textgreater= 4.
...
\item
  n = 4: \textbf{PROVED} (algebraic reduction plus computational verification (PHCpack), pending fully certified global path accounting for Case 3c).
\item
...
\subsubsection{5b. What remains open for n \textgreater= 4}
...
\textbf{The inequality is established for n \textless= 4, with strong numerical evidence beyond that range.}
...
4 & \textbf{PROVED} & algebraic reduction + PHCpack verification; pending fully certified global path accounting for Case 3c \\
...
For higher n this structure does not persist in a directly usable form.
