...
\textbf{Verification for \(n = \mNumber{2}\).} Take \(\lambda =\) (a, 0). Both conventions give
...
Take \(\lambda\)=(a,0), state space \(\{(a,\mNumber{0}),(\mNumber{0},a)\}\). There is one non-vacancy and one
