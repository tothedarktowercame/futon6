...
(ensuring \(\pi\) sums to 1). Positivity: \(F_{\eta}\)(x; 1, t) \(>\) 0 for \(x_{i} > \mNumber{0}, \mNumber{0} \le t < \mNumber{1}\) is established as part of AMW Theorem 1.1, which shows that
...
\tightlist
\item
  (a,0) \(\to\) (0,a) at rate \(\mNumber{1}/x_\mNumber{1}\)
\item
  (0,a) \(\to\) (a,0) at rate \(\mNumber{1}/x_\mNumber{2}\)
\end{itemize}
