...
Let \(\lambda\) = (\(\lambda_\mNumber{1}\) \textgreater{} ... \textgreater{} \(\lambda_{n}\) \textgreater= 0) be a restricted partition with
...
(ensuring \(\pi\) sums to 1). Positivity: \(F_{\eta}\)(x; 1, t) \textgreater{} 0 for \(x_{i} > \mNumber{0}\),
\(\mNumber{0} \le t < \mNumber{1}\) is established as part of AMW Theorem 1.1, which shows that
