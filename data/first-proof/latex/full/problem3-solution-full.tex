...
Let \(\lambda = (\lambda_{\mNumber{1}} >\) ... \textgreater{} \(\lambda_{n}\) \textgreater= 0) be a restricted partition with
...
(ensuring \(\pi\) sums to 1). Positivity: \(F_{\eta}\)(x; 1, t) \textgreater{} 0 for \(x_{i} > \mNumber{0}, \mNumber{0} \le t < \mNumber{1}\) is established as part of AMW Theorem 1.1, which shows that
...
\tightlist
\item
  (a,0) -\textgreater{} (0,a) at rate \(\mNumber{1}/x_\mNumber{1}\)
\item
  (0,a) -\textgreater{} (a,0) at rate \(\mNumber{1}/x_\mNumber{2}\)
\end{itemize}
...
probability \(\mNumber{1}/[m]_t > \mNumber{0}\) (the k=1 term in the t-geometric distribution, where
