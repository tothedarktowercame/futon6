...
\(H_ \ast (M_{tilde}; Q) = \mNumber{0}\) for \(* > \mNumber{0}\). Obligation E2 gives a finite CW
...
\texttt{Y} with \(\pi_\mNumber{1}(Y) = \Gamma\) and \(H_ \ast (Y_{tilde}; Q) = \mNumber{0}\) for \(* > \mNumber{0}\).
...
manifold \texttt{N} with \(\pi_\mNumber{1}(N) = \Gamma\) and \(H_ \ast (N_{tilde}; Q) = \mNumber{0}\) for
