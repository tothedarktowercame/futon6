...
\phantomsection\label{sn:p6}
\statusnote{Unconditional closure holds for the $K_n$ branch. The general-graph
theorem remains conditional on two explicit BMI regime lemmas in the
$M_t \ne 0$ branch.}
