...
identifications, and the central thesis.  The diagram follows the
AIF (Argument Interchange Format) conventions used for the monograph's
proof-level wiring diagrams, applied here at the paper level.
Dashed red arrows denote challenges (threats to validity) directed at
specific claims.

\begin{figure}[p]
\centering
\input{plates/sprint-review-wiring-tikz.tex}
