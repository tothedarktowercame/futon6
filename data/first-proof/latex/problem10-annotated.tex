...
\subsection*{Status and assumptions}
This result is \textbf{conditional}: it is closed under explicit assumptions
($\lambda>0$, $K_\tau \succ 0$, and sampling/coherence conditions controlling
preconditioned conditioning). Necessity counterexamples are recorded in the
full writeup when these assumptions are dropped.
