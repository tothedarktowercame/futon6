...
\item \textbf{Closed.} A complete proof (possibly with minor caveats).
  In the current QC pass, Problems 1, 2, 7, 8, and 9 are provisionally
  closed pending node-level validation; Problem~3 has a largely validated
  existence path with one remaining validator gap in an optional uniqueness
  layer; Problem~10 is conditional under stated assumptions; Problem~5 is
