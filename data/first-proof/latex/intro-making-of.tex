...
The title of this monograph alludes to Pease et
...
grounded in Lakatos's framework, using Inference Anchoring Theory with
Computation (IATC) to annotate MathOverflow threads with performative types
