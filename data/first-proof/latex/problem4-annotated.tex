...
\subsection*{Answer}
Partial result: proved analytically for $n \le 3$; the $n=4$ branch has
algebraic reduction plus computational verification, with one certification
step still pending; higher $n$ remains open.
