...
\node[synth] (N2) at (4.8, 8.0) {P6 near miss\\object inertia};

%% ═══════════════════════════════════════════════════════
%% THREATS (right margin)
%% ═══════════════════════════════════════════════════════
\node[chall] (V1) at (8.4, 10.8) {Non-blinded\\evaluation};
\node[chall] (V2) at (8.4, 8.6) {Baseline\\comparability};
\node[chall] (V3) at (8.4, 7.5) {Attribution\\uncertainty};
...
\draw[exemp] (TB.280) -- (N1.north);
\draw[exemp] (TB.east)
  to[out=-10, in=130] (6.6, 10.6)
  to[out=-95, in=15] (N2.east);
