...
giving $L(s, \Pi \times \pi)$ | L_phi (in a PID, (a) ⊆ (b) iff b | a).
...
Taking the union over all $\phi'$: the full ideal $L(s, \Pi \times \pi)$ · R =
$\bigcup_{\phi'}$ $\Phi(\phi')$ ⊆ L_phi · R. So L_phi | $L(s, \Pi \times \pi)$.
