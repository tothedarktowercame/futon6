...
|---|---|---|---|---|
| P1 | closed / fully solved | `problem1-codex-results.jsonl` | validated | 9 outputs: 7 verified, 2 plausible, 0 gap, 0 error |
| P2 | closed / fully solved | `problem2-codex-results.jsonl` | validated | 10 outputs: 4 verified, 6 plausible, 0 gap, 0 error |
...
| P8 | closed / fully solved | `problem8-codex-results.jsonl` | validated | 11 outputs: 10 verified, 1 plausible, 0 gap, 0 error |
