...
|---|---|---|---|---|
| P1 | closed / fully solved | `problem1-codex-results.jsonl` | partial validation | 9 outputs: 0 verified, 1 plausible, 8 gap, 0 error |
| P2 | closed / fully solved | `problem2-codex-results.jsonl` | partial validation | 10 outputs: 0 verified, 3 plausible, 7 gap, 0 error |
...
| P7 | closed / fully solved | `problem7-codex-results.jsonl` | partial validation | 9 outputs: 1 verified, 2 plausible, 6 gap, 0 error |
| P8 | closed / fully solved | `problem8-codex-results.jsonl` | partial validation | 11 outputs: 0 verified, 4 plausible, 7 gap, 0 error |
| P9 | closed / fully solved | `problem9-codex-results.jsonl` | partial validation | 12 outputs: 1 verified, 2 plausible, 9 gap, 0 error |
