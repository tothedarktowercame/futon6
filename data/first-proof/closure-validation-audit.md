...
| P3 | closed / fully solved | `problem3-codex-results.jsonl` | partial validation | 9 outputs: 3 verified, 5 plausible, 1 gap (`p3-s7`, uniqueness layer) |
...
| P7 | closed / fully solved | none found | pending validation | strong theorem-chain claim, but no node-level run artifact |
| P8 | closed / fully solved | none found | pending validation | proof text exists; no current codex-results artifact |
| P9 | closed / fully solved | none found | pending validation | proof text exists; no current codex-results artifact |
...
- `provisionally closed in manuscript form, validation pending`
  (P1, P2, P7, P8, P9);
- `existence path validated with one remaining validator gap in optional uniqueness layer`
  (P3);
