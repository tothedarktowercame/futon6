...
#
# 2 failures - 1 missing data fixture, 1 babashka:
#   The test reads a data fixture kept in the checkout that is not present here
#   (e.g. data/iatc-argument-graphs/loop-run-70b/*.edn,
#   data/iatc-candidates/*.candidate.json, data/showcases/ct-anatomy/golden/*).
#   These are committed run outputs; a run driven through run_manifest writes its
#   artifacts under the run directory instead, so they are not regenerated by
#   running the pipeline. Missing input, not a defect in the code under test.
#
